...
public class EntrepriseTest {
	...
	public void exo003() throws Exception {
		//Créer la classe générique com.ipiecoles.java.java220.Unite ayant deux attributs responsable de type générique et membres, qui est un
		...
		TestUtils.checkPrivateField("com.ipiecoles.java.java220.Unite", "responsable", TestUtils.OBJECT);
		TestUtils.checkPrivateField("com.ipiecoles.java.java220.Unite", "membres", TestUtils.HASHSET);

		TestUtils.checkMethod("com.ipiecoles.java.java220.Unite", "getResponsable", TestUtils.OBJECT);
		TestUtils.checkMethod("com.ipiecoles.java.java220.Unite", "setResponsable", "void", TestUtils.OBJECT);

		TestUtils.checkMethod("com.ipiecoles.java.java220.Unite", "getMembres", TestUtils.HASHSET);
		TestUtils.checkMethod("com.ipiecoles.java.java220.Unite", "setMembres", "void", TestUtils.HASHSET);

		TestUtils.checkConstructor("com.ipiecoles.java.java220.Unite");
		TestUtils.checkConstructor("com.ipiecoles.java.java220.Unite", TestUtils.OBJECT);


		//noinspection deprecation
		TestUtils.checkMethod(TestUtils.getClasse("com.ipiecoles.java.java220.Unite"), "ajouterMembre", void.class, Object[].class);
		TestUtils.checkMethod("com.ipiecoles.java.java220.Unite", "toString", TestUtils.STRING);
		...
		com.ipiecoles.java.java220.Unite<Technicien> employeEquipeT1 = new com.ipiecoles.java.java220.Unite<>(t1);
		employeEquipeT1.ajouterMembre(t2);

		com.ipiecoles.java.java220.Unite<Technicien> employeEquipeT2 = new com.ipiecoles.java.java220.Unite<>(t3);
		...
		com.ipiecoles.java.java220.Unite<Manager> employeEquipeM1 = new com.ipiecoles.java.java220.Unite<>(m1);
		...
		com.ipiecoles.java.java220.Unite<Commercial> employeEquipeC1 = new com.ipiecoles.java.java220.Unite<>(c1);
		employeEquipeC1.ajouterMembre(c2, c3);

		com.ipiecoles.java.java220.Unite<com.ipiecoles.java.java220.Unite> entreprise = new com.ipiecoles.java.java220.Unite<>(employeEquipeM1);
		entreprise.ajouterMembre(employeEquipeT1, employeEquipeC1);

		System.out.println(entreprise);

		com.ipiecoles.java.java220.Unite<Employe> ensembleEmployes = new com.ipiecoles.java.java220.Unite<>(t1);
